...
from models.itcnu_model import Multitask_EmotionNet
...
class Tester_MTL(Tester_Single_task):
    ...
    def predict_multiple_videos(self):
        ...
        self.save_to_file('test_MTL_predictions_face_'+args.ckp[len('./ensemble_global_face/face/'):-5]+'.txt', lines)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckp', type=str, default='./results/face/model-epoch=73-val_total=0.58.ckpt',
    ...
    model.cuda()
    img_size = 299
    annotation_file = 'ann/MTL/MTL_test_set_face.pkl'
